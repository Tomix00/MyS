...
class continousGenerators:
    def exponential1() -> float:
        """
        Via the inverse transform method, generates a random variable
        following a exponential distribution with lambda = 1.
        Returns:
            float: A random number following a exponential distribution.
        """
        U = 1 - random()
        return -math.log(1-U)

    def exponentialL(lam: float) -> float:
        """
        Via the inverse transform method, generates a random variable
        following a exponential distribution with parameter lamda = 1.
        Parameters:
            lam (float): The rate parameter of the Poisson distribution.
        Returns:
            float: A random number following a exponential distribution.
    ...
    def poisson_with_exp(lam: float) -> float:
        """
        Needs docstring
        """
        x = 0
    ...
    def gamma(n: int, lam: float) -> float:
        """
        Needs docstring
        """
        U = 1
